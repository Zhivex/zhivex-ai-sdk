...
`createChatCompletionsModel` is a Beta provider-construction helper available from
Core, SDK and `@zhivex-ai/core/provider`. It implements the shared Chat Completions
